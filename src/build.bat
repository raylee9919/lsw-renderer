...
call cl %CCFLAGS% %COMMON_DEFINE% -Od ..\src\win32.cpp -Fe:engine.exe /link %WINDOWS_LIB%

:: Vulkan ::
set VK_INCLUDE_DIR=C:\\VulkanSDK\\1.4.309.0\\Include
set VK_LIB_DIR=C:\VulkanSDK\1.4.309.0\Lib
